 ...
 */
import type { AuthorityFailure, AuthorityTelemetry } from './game/magnetite-authority';
import type { BackendInfo } from '@vulos/wibbly-input';

declare global {
  interface Window {
    /** Live magnetite authority telemetry, or a failure record — see src/game/game.tsx. */
