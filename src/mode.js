 ...
 *
 * The demo build is the one embedded at `vulos.org/products/wibbly/play/`
 ...
 * @param baseUrl  the build's base path, e.g. '/' or '/products/wibbly/play/'
 ...
 * the moment the app is served from `/products/wibbly/play/` — the request
