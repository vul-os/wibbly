...
type MultiplayerCta = 'hidden' | 'open' | 'dismissed';
...
export default function Demo() {
  ...
  const [cta, setCta] = useState<MultiplayerCta>('hidden'); // hidden | open | dismissed
   ...
   */
  const onTrackerBackend = useCallback((info: BackendInfo) => {
 ...
 */
function MultiplayerNote({ onClose }: { onClose: () => void }) {
  return (
