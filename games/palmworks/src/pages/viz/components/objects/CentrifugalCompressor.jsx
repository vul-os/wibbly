...
const CentrifugalCompressor = ({ position, onClick, onDrag, isSelected, isDraggable, gridSnap, gridSize, onPortClick }) => {
  ...
  return (
    ...
    >
      ...
      {Array.from({ length: 4 }, (_, i) => {
        const positions = [[1.5, 1.8, 0], [-1.5, 1.8, 0], [2.5, 1.8, 0.5], [0, 1.8, 1.5]];
        return (
