...
import { createPlayer, updatePlayerMovement } from '../src/game/player.js';
 ...
 */
function runFor(fps, seconds, isLeftSide = true) {
  const player = createPlayer(0, 0, Math.PI / 2, 1);
  const data = { targetX: 100, targetZ: 0, isLeftSide };
  const delta = 1 / fps;
