...
import { GAMES, type GameEntry } from '../components/catalogue';
import { setupState } from '../components/game-settings';
...
const GameArt = ({ kind, planned }: GameArtProps) => {
  ...
  return (
    <div className="wb-court">
      ...
      <div className="wb-stage wb-title">
        {/* ── Title card ────────────────────────────────────────────────── */}
        <header className="wb-title__head wb-rise" style={riseDelay(0)}>
        ...
        {/* ── Now selected ──────────────────────────────────────────────── */}
        <section className="wb-title__detail wb-rise" style={riseDelay(2)} aria-live="polite">
        ...
        <footer className="wb-title__foot wb-rise" style={riseDelay(3)}>
