...
const STEP_LABELS = { intro: 'Permission', handedness: 'Handedness', framing: 'Framing' };
  ...
  return (
    <div className="wb-court">
      ...
      <div className="wb-stage wb-setup">
        <header className="wb-setup__head wb-rise" style={{ '--i': 0 }}>
          <div>
        ...
        <ol className="wb-setup__rail wb-rise" style={{ '--i': 1 }}>
          {STEPS.map((s, i) => (
            <li
              key={s}
        ...
        {step === 'intro' && (
          <section className="wb-setup__intro wb-rise" style={{ '--i': 2 }}>
        ...
        {step === 'handedness' && (
          <section className="wb-setup__split wb-rise" style={{ '--i': 2 }}>
            {stage}
            <div className="wb-panel wb-panel--framed wb-setup__panel">
              <div>
